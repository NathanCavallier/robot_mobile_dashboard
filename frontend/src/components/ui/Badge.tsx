  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        success: // Variant personnalisé
          "border-transparent bg-green-500 text-white hover:bg-green-500/80 dark:bg-green-600 dark:hover:bg-green-600/80",
        warning: // Variant personnalisé
          "border-transparent bg-yellow-500 text-black hover:bg-yellow-500/80 dark:bg-yellow-500 dark:hover:bg-yellow-500/80",
